...
angular.module("website.core.settings", ["ng"]), angular.module("website.core.dependency", ["website.core.settings"]), angular.module("website", ["core.library.jsonrpc", "website.core", "website.widgets", "website.plugins", "website.moto_link"]).run(["jsonrpc", function(a) {
  a.setBasePath(window.websiteConfig && window.websiteConfig.apiUrl ? websiteConfig.apiUrl : "/api.php")
}]), angular.module("website.widgets", ["website.widget.contact_form", "website.widget.mail_chimp", "website.widget.slider", "website.widget.grid_gallery", "website.widget.carousel", "website.widget.disqus", "website.widget.facebook_page_plugin", "website.widget.twitter", "website.widget.pinterest", "website.widget.menu"]), angular.module("website.plugins", []), angular.module("website.core", ["website.core.settings", "website.core.dependency"]), angular.module("website.core").config(["motoWebsiteSettingsServiceProvider", function(a) {
  ...
  l = {
    ...
    facebook: {
      ...
      preInject: function() {
        ...
        a || (a = document.createElement("div"), a.id = "fb-root", e().appendChild(a))
      },
      postInject: angular.noop,
      require: function() {
        return h.require(this.name), this
    ...
    google_plus: {
      ...
      preInject: function() {
        ...
        b.lang = b.lang || a.get("preferredLanguage", "en"), window.___gcfg = b
      },
      postInject: angular.noop,
      require: function() {
        return h.require(this.name), this
  ...
  function d(a) {
    ...
    var b, c = a.isAttached || a.options.hidden ? a.$pseudoElement : a.$element,
  ...
  function e(a) {
    var b = 0;
    try {
      a.$pseudoElement.show(), s || a.$element.innerWidth(a.$pseudoElement.innerWidth()), a.options.hidden || a.$pseudoElement.height(a.$element.outerHeight(!0)), s && (a.$element.removeClass(o.attachedClass).removeClass(o.attachedClass + "_" + a.options.direction).removeAttr("style"), b = a.$element.innerWidth(), a.$element.innerWidth(b), a.$pseudoElement.innerWidth(b), a.$element.addClass(o.attachedClass).addClass(o.attachedClass + "_" + a.options.direction))
    } catch (d) {
  ...
  function i(a) {
    try {
      ...
      r = !1;
      for (var d = 0, e = q.length; e > d; d++) h(q[d]);
      s = !1
    } catch (f) {
  ...
  angular.element('[data-action="lightbox"].moto-link').magnificPopup({
    type: "image"
  ...
  var g, h, i = b.find("input, textarea"),
    j = /^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,4})$/;
  if (a.message = {}, a.placeholder = {}, a.hash = "", a.attachments = [], a.attachment = {}, i.length)
    for (var k = 0, l = i.length; l > k; k++) g = angular.element(i[k]), h = g.attr("name"), h && (a.message[h] = a.message[h] || "", a.placeholder[h] = g.attr("placeholder") || h);
  a.validateEmailOnBlur = function() {
    ...
    }), a.contactForm.$valid = !1) : a.contactForm.$valid = !0, a.validate("email"), a.contactForm && a.contactForm.$valid && !a.contactForm.emailInvalid && (a.attachments.length ? (a.message._attachments = a.attachments.length, d.upload({
      method: "POST",
      url: c.getApiPath(),
      file: a.attachments,
      data: {
    ...
    }).success(e).error(f)) : c.sendMessage({
      message: a.message,
      placeholder: a.placeholder,
      hash: a.hash
    }).success(e).error(f))
  ...
  var f, g, h = b.find("input"),
    i = /^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,4})$/;
  if (a.listId = "", a.message = {}, a.emailSent = !1, a.triedToSend = !1, a.emailError = !1, a.isSubscribed = !1, h.length)
    for (var j = 0, k = h.length; k > j; j++) f = angular.element(h[j]), g = f.attr("name"), g && (a.message[g] = a.message[g] || "");
  a.validateEmailOnBlur = function() {
    ...
    a.emailSent = !1, a.triedToSend = !0, a.sending = !0, a.emailError = !1, a.isSubscribed = !1, "object" == typeof a.subscribeForm.$error.required ? (a.subscribeForm.$error.required.forEach(function(a) {
      a.$dirty = !0, a.$pristine = !1, a.$setTouched()
    }), a.subscribeForm.$valid = !1) : a.subscribeForm.$valid = !0, a.validate("email"), a.subscribeForm && a.subscribeForm.$valid && !a.subscribeForm.emailInvalid && (a.message.list_id = a.listId || "", c.subscribe({
      request: a.message
    }).success(d).error(e))
  }
